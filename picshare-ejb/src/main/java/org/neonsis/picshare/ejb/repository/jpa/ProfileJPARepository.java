...
@Dependent
public class ProfileJPARepository extends AbstractJPARepository<Profile, Long> implements ProfileRepository {
    ...
    public Optional<Profile> findByEmail(String email) {
        try {
            Profile profile = (Profile) em.createNamedQuery("Profile.findByEmail")
    ...
    @Override
    @JPAQuery("SELECT p FROM Profile p WHERE p.uid IN :uids")
    public List<String> findUids(List<String> uids) {
        return em.createNamedQuery("Profile.findUids")
